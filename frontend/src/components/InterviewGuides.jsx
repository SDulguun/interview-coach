...
const guides = [
  ...
  },
  {
    ...
    content: {
      mn: {
        summary: 'STAR арга бол зан төлөвийн (туршлагын) асуултуудад хариулах хамгийн үр дүнтэй хүрээ.',
        points: [
          ...
          'Жишээ: "Манай баг оноогдсон хугацаанаасаа хоцорч байсан (S). Би ахлах хөгжүүлэгчийн хувьд (T) даалгаврыг дахин хуваарилж, өдөр бүр богино уулзалт зохион байгуулсан (A). Үр дүнд бид хугацаандаа амжсан (R)."',
        ],
