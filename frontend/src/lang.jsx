...
const translations = {
  ...
  setup_desc: { mn: 'Тав тухаа олоод, өөртөө тохирсон ажлын төрлөө сонгоорой. Энэ бол жинхэнэ ярилцлага биш, тиймээс алдахаас айх хэрэггүй — төгсгөлд нь ээлтэй, бүтээлч үнэлгээ авах болно.', en: 'Take your time and pick a category that fits you. This isn\'t a real interview — no pressure. You\'ll get warm, constructive feedback at the end.' },
  ...
  err_no_answers: { mn: 'Та нэг ч асуултад хариулаагүй байна. Дахин эхлүүлж, ядаж нэг асуултад хариулаарай — бид танд тусалмаар байна 🙂', en: 'You did not answer any questions. Try again and answer at least one — we want to help 🙂' },
  ...
  session_complete: { mn: 'Сайхан ярилцлаа, баярлалаа! Хариултуудыг тань шинжилж байна...', en: 'Great conversation, thank you! Analyzing your responses now...' },
  ...
  welcome_tagline: { mn: 'Ярилцлагадаа тайван, итгэлтэй бэлдэцгээе', en: 'Let\'s get you ready — calm, confident, and prepared' },
  ...
  interviewer_responding: { mn: 'Ярилцлага авагч хариу өгч байна...', en: 'The interviewer is replying...' },
